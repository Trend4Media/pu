...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Registration successful, redirect to character creation
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-space-dark to-gray-900">
      <div className="max-w-md w-full space-y-8 p-8">
        <div className="text-center">
          <h2 className="text-3xl font-bold text-space-gold">Create Account</h2>
          <p className="mt-2 text-gray-400">Join the galactic conquest</p>
        </div>
        ...
        <div className="text-center">
          <p className="text-gray-400">
            ...
            <Link href="/login" className="text-space-blue hover:text-blue-400">
              Sign in
            </Link>
          </p>
        </div>
